...
?>
	...
	<h3>Thank You!</h3>
	<p>Your order has been processed. An email has been sent to <?php echo $customerEmail; ?> for your records.</p>
...
?>
	...
	<div id="orderArea">
	<form name="orderAreaForm" method="post" action="customerRegistrationForm1.php">

...
CREATE TABLE `wdv341_event table` (
...
INSERT INTO `formatEvents_table` (`event_id`, `event_name`, `event_description`, `event_presenter`, `event_date`, `event_time`) VALUES
...
--
ALTER TABLE `wdv341_event table`
